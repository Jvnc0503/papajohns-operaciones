...
QUEUE_URL = os.environ.get("SQS_DESPACHO_URL")

def handler(event, context):
    if not QUEUE_URL:
        return server_error("URL de la cola SQS de Despacho no configurada")
    ...
    try:
        ...
        print(f"Error al leer la cola SQS de Despacho: {str(e)}")
