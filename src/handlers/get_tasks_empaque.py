...
QUEUE_URL = os.environ.get("SQS_EMPAQUE_URL")

def handler(event, context):
    if not QUEUE_URL:
        return server_error("URL de la cola SQS de Empaque no configurada")
    ...
    try:
        ...
        print(f"Error al leer la cola SQS de Empaque: {str(e)}")
